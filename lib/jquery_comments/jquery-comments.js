...
(function (factory) {
    ...
    var Comments = {
        ...
        init: function(options, el) {
            ...
            if(!this.options.readOnly) this.$el.removeClass('read-only');
        ...
        createNavigationElement: function() {
            ...
            // Populate elements
            navigationWrapper.append(oldest).append(newest);
            dropdownNavigation.append(oldest.clone()).append(newest.clone());
        ...
        createCommentWrapperElement: function(commentModel) {
            ...
            if((commentModel.createdByCurrentUser || this.options.currentUserIsAdmin) && this.options.enableEditing) {
